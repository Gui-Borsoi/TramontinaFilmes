...
namespace TramontinaFilmes.WebApi.Infraestrutura
{
    public sealed class SessoesRepositorio
    {
        ...
        public async Task<List<SessaoFilmeReturnModel>> RecuperarSecoesFilme(SessaoFilmeInputModel sessaoFilmeInputModel, CancellationToken cancellationToken = default)
        {
